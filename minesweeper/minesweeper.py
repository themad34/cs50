    ...
    def add_knowledge(self, cell, count):
        ...
        while update == True:
            ...
            for S in self.knowledge:
                for new_safe in S.known_safes():
                    new_safes += [new_safe]
                    update = True
                    
                for new_mine in S.known_mines():
                    new_mines += [new_mine]
                    update = True
                ...
                for S2 in self.knowledge:
                    ...
                    if S1.cells < S2.cells:
                        ...
                        if new_sentence not in self.knowledge:
                            ...
                            for new_safe in new_sentence.known_safes():
                                self.mark_safe(new_safe)
                            for new_mine in new_sentence.known_mines():
                                self.mark_mine(new_mine)
                            update = True
            
            for new_sentence in new_sentences:
                self.knowledge += [new_sentence]
